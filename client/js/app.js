  ...
  .config(['$stateProvider', '$urlRouterProvider', function($stateProvider,
    ...
    $stateProvider
	  ...
	  .state('orders', {
       ...
       .state('transportOperators', {
        url: '/transportOperators',
        templateUrl: 'views/transport-operators.html',
        controller: 'TransportOperatorController',
        authenticate: true
      })
      .state('vendors', {
        url: '/vendors',
      ...
      .state('deliveredOrders', {
          url: '/deliveredOrders',
          templateUrl: 'views/deliveredOrders.html',
          controller: 'DeliveredOrdersController',
          authenticate: true
        })
      .state('users', {
        url: '/users',
