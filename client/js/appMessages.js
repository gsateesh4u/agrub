...
xlat.factory('xlatService', function() {
  ...
  var tables = {
		    'en': { 'appLogo':'AGRUB','lbl_toggle_nav':'Toggle Navigation','menu_customers':'Customers','menu_users':'Users','menu_items':'Items','menu_item_cat':'Item Categories','menu_hubs':'Hubs','menu_reports':'Reports','menu_orders':'Orders','menu_prices':'Pricing','menu_DMPH':'DMP History',
				'menu_upload_order':'Upload Order', 'menu_SO':'Sales Orders', 'menu_PO':'Purchase Orders', 'menu_DC':'Delivery Chalans','menu_DO':'Delivered Orders','menu_DMP':'Daily Market Prices','menu_Cust_Lock_Periods':'Customer Lock Periods','menu_Cust_Prices':'Customer Prices','menu_markets':'Markets',
				...
				'tbl_head_prices':'Pricing','tbl_head_upload_order':'Upload Order','tbl_head_DC':'All Delivery Chalans','tbl_head_DO':'All Delivered Orders','tbl_head_Markets':'Markets'}
              };
